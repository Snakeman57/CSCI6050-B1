...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3511670380ltr&server=1">
...
// <![CDATA[
CommonParams.setAll({common_query:"",opendb_url:"index.php?route=/database/structure",lang:"en",server:"1",table:"",db:"",token:"4722604c416c7835774b22416c412b46",text_dir:"ltr",show_databases_navigation_as_tree:true,pma_text_default_tab:"Browse",pma_text_left_default_tab:"Structure",pma_text_left_default_tab2:false,LimitChars:"50",pftext:"P",confirm:true,LoginCookieValidity:"1440",session_gc_maxlifetime:"1440",logged_in:true,is_https:false,rootPath:"/phpmyadmin/",arg_separator:"&",PMA_VERSION:"5.1.3",auth_type:"HTTP",user:"root"});
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=CinemaWeb&table=Customer">`CinemaWeb`.`Customer`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=CinemaWeb&table=admin">`CinemaWeb`.`admin`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=CinemaWeb&table=paymentCard">`CinemaWeb`.`paymentCard`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=CinemaWeb&table=Booking">`CinemaWeb`.`Booking`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=CinemaWeb&table=Registration">`CinemaWeb`.`Registration`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="4722604c416c7835774b22416c412b46">
...
<div id="topmenucontainer" class="menucontainer">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="CinemaWeb" targettable="Customer">
            ...
            Queried time
                            ...
                            <span class="query">EXPLAIN SELECT * FROM `Customer`;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="CinemaWeb" targettable="Customer">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `Customer` CHANGE `UserID` `UserID` INT(50) NOT NULL AUTO_INCREMENT, CHANGE `paymentCard` `paymentCard` VARCHAR(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL, CHANGE `state` `state` VARCHAR(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL, CHANGE `booking` `booking` VARCHAR(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="CinemaWeb" targettable="Customer">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `Customer` (
  ...
  UNIQUE KEY `booking_UNIQUE` (`booking`)
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `Customer` DROP PRIMARY KEY, ADD PRIMARY KEY(`username`);</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="CinemaWeb" targettable="Customer">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `Customer` DROP PRIMARY KEY, ADD PRIMARY KEY(`UserID`);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="CinemaWeb" targettable="Customer">
                            <div class="action_content">
