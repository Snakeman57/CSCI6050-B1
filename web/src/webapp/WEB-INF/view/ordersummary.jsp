...
<body>
   ...
   <div class="order-summary-text">
       <h1 style="font-size: 65px;">Order Summary</h1>
   </div>
   ...
   <div class="container">
       <br>
        <div style="float: left;">
            <h4 class="text-start">Your Tickets</h4>
                <button class="btn bg-primary text-white" id="add-tickets"><a href="selectseats.html" style="color: white;">Add Tickets</a></button>
        </div>
       <table class="table">
           <thead>
               <tr>
           ...
           <tbody>
               <tr>
                   ...
                   <td>C1</td>
                   <td>
                       <button class="btn bg-primary text-white" id="remove">Remove</button>
                   </td>
               </tr>
               <tr>
                   <td>1 Child</td>
       ...
       <a href="checkout.html"><button style="margin-bottom: 60px; margin-top: 20px;" class="btn bg-success text-white">Continue to Checkout</button></a>
   </div>
