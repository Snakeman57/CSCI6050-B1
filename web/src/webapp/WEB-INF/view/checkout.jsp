...
<body>
    ...
    <div class="checkout-title">
        <h1 style="font-size: 65px; margin-top: 1.5vw;">Checkout</h1>
    </div>
            ...
            <div class="col-md-4 order-md-2 mb-4">
                ...
                <ul class="list-group mb-3 sticky-top">
                    <li class="list-group-item d-flex justify-content-between lh-condensed">
                        <div>
                            <h6 class="my-0">1 Adult</h6>
                            <small class="text-muted">The Kingsman</small>
                        </div>
                        <span class="text-muted">$12.49</span>
                    </li>
                    <li class="list-group-item d-flex justify-content-between lh-condensed">
                        <div>
                            <h6 class="my-0">1 Child</h6>
                            <small class="text-muted">The Kingsman</small>
                        </div>
            ...
            <div class="col-md-8 order-md-1">
                ...
                <form class="needs-validation" novalidate="">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control" id="email" placeholder="you@example.com">                    </div>
                    <div class="mb-3">
                    ...
                    <hr class="mb-4">
                    <button style="margin-bottom: 20px;"class="btn btn-primary btn-lg btn-block" type="submit">Place Order</button>
                </form>
            </div>
        </div>
    </div>
