...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            <a href="index.php" class="navbar-brand">B1 Cinemas</a>
    ...
    <nav class="px-2 pt-3 pb-1 bg-dark" aria-label="Coming soon movies">
        <ul class="pagination pagination-lg justify-content-center">
            <li class="page-item active"><a class="page-link" href="index.php">Currently Showing</a></li>
            <li class="page-item"><a class="page-link" href="coming-soon.php">Coming Soon</a></li>
        </ul>
    </nav>
