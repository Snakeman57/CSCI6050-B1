...
namespace CineWeb.Migrations
{
    ...
    [Migration("20220504161316_mtest_0.1.9")]
    partial class mtest_019
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CineWeb.Data.CineWebUser", b =>
                {
                    ...
                    b.Property<uint?>("PaymentCard1ID")
                        .HasColumnType("INTEGER");

                    b.Property<uint?>("PaymentCard2ID")
                        .HasColumnType("INTEGER");

                    b.Property<uint?>("PaymentCard3ID")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("PaymentCard1ID");

                    b.HasIndex("PaymentCard2ID");

                    b.HasIndex("PaymentCard3ID");
            ...
            modelBuilder.Entity("CineWeb.Models.PayCard", b =>
                {
                    b.Property<uint>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<string>("AddrStreet1")
                        .HasColumnType("TEXT");

                    b.Property<string>("AddrStreet2")
                        .HasColumnType("TEXT");

                    b.Property<string>("AddrZip")
                        .HasColumnType("TEXT");

                    b.Property<uint>("CardNumber")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("CineWeb.Data.CineWebUser", b =>
                {
                    b.HasOne("CineWeb.Models.PayCard", "PaymentCard1")
                        .WithMany()
                        .HasForeignKey("PaymentCard1ID");

                    b.HasOne("CineWeb.Models.PayCard", "PaymentCard2")
                        .WithMany()
                        .HasForeignKey("PaymentCard2ID");

                    b.HasOne("CineWeb.Models.PayCard", "PaymentCard3")
                        .WithMany()
                        .HasForeignKey("PaymentCard3ID");

                    b.HasOne("CineWeb.Models.Role", null)
                        .WithMany("Users")
                        .HasForeignKey("RoleId");

                    b.Navigation("PaymentCard1");

                    b.Navigation("PaymentCard2");

                    b.Navigation("PaymentCard3");
                });
